  ...
  return (
    <>
      ...
      <div className={styles.tabs}>
        ...
        <NavLink
          to={`/student-dashboard/${params.projectId}/instructions`}
          className={({ isActive }) =>
            isActive ? styles.navLinkActive : styles.navLink
          }
        >
        ...
        <NavLink
          to={`/student-dashboard/${params.projectId}/video-tutorial`}
          className={({ isActive }) =>
            isActive ? styles.navLinkActive : styles.navLink
          }
        >
        ...
        <NavLink
          to={`/student-dashboard/${params.projectId}/make-project`}
          className={({ isActive }) =>
            isActive ? styles.navLinkActive : styles.navLink
          }
        >
        ...
        <NavLink
          to={`/student-dashboard/${params.projectId}/submit-project`}
          className={({ isActive }) =>
            isActive ? styles.navLinkActive : styles.navLink
          }
        >
  ...
  return (
    <>
      ...
      <div className={styles.tabs}>
        ...
        <NavLink
          to="/teacher-dashboard/project-submissions"
          className={({ isActive }) =>
            isActive ? styles.navLinkActive : styles.navLink
          }
        >
